...
formEl, addEventListener("input", (0, _lodashThrottleDefault.default)(storageFormData, 500));
...
function onFormSubmit(e) {
    e.preventDefault();
    if (e.target.elements.email.value === "" || e.target.elements.message.value === "") return alert(`Заповніть всі поля!`);
